    ...
    <div>
      <section className="text-gray-600 body-font relative ">
        <div className="container px-5 py-20 mx-auto sm:w-8/12 ">
          ...
          <div className="lg:w-2/3 md:w-full sm:w-full w-full mx-auto">
            <div className="flex flex-wrap -m-2 mx-auto place-content-center">
              <div className="p-4 w-2/3">
                <div className="relative ">
                  <label for="name" className="leading-7 text-sm text-mCream">
                    아이디
                  </label>
                  <input
                    type="text"
              ...
              <div className="p-4 w-2/3">
                <div className="relative">
                  <label for="password" className="leading-7 text-sm text-mCream">
                    비밀번호
                  </label>
                  <input
                    type="password"
              ...
              <div className="p-10 w-full border-t-4 border-mYellow">
                <button className="flex text-center  mx-auto rounded-lg bg-[#F1BF45] border-0 py-2 px-24 focus:outline-none hover:bg-mCream rounded text-lg">
                  카카오로그인
                </button>
              </div>
              <div className="p-2 w-full pt-4 mt-2 text-center">
                <span>
                  계정이 없으신가요? &emsp;
                  <button className=" mx-auto rounded-lg bg-mCream border-0 py-1 px-10 focus:outline-none hover:bg-mYellow rounded text-lg">
                    회원가입
                  </button>
                </span>
              </div>
